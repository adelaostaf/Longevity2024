%% Preprocessing longevity EEG data
%
clear; clc
...
% set info
subj_id = 'subj53'; % change with the ID of the subj to analyse
group = 'long'; 
task = 'ratings'; % this can be 'ratings', 'unimodal' or 'test'
...
cfg.trialdef.eventvalue = 61956; % stimulus onset
...
cfg.task = 'RatingsData';
cfg.subj_id = subj_id;
cfg.group = [group '_group'];
[combined_trl_info, trial_info_ext] = trialfun_longevity_TIME2(cfg);
...
% add more info about trials
trials.trl_info_extended = trial_info_ext;
...
cfg = [];
cfg.component = [1 7 10 15 16 ]; % components to remove
