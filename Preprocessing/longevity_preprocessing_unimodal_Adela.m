%% Preprocessing UNIMODAL - longevity EEG 
%
clear; clc
...
cfg.trialdef.eventvalue = 65284; % stimulus onset
...
% run this code if you need to remove some muscle artifacts
visual_artf = artif.artfctdef.visual.artifact;
% remove artifacts
cfg = [];
cfg.artfctdef.reject = 'complete';
cfg.artfctdef.visual.artifact = visual_artf;
artrej_2_ma = ft_rejectartifact(cfg, artrej_2_ma);
...
cfg = [];
cfg.component = [1 12 17]; % components to remove
